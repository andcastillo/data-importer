...
console.log(head + ',dist1,dist2,torsion,angle,hoseA1,hoseA2,hoseA3,hoseA4,hoseA5,hoseB1,hoseB2,hoseB3,hoseB4,hoseB5');
...
for (let i = 500000; i < max; i++) {
  ...
  + ',' +example[4] + ',' +example[5]
  + ',' + distance1(molecule, inverseMap[example[2]], inverseMap[example[3]]) 
  + ',' + distance2(molecule, inverseMap[example[2]], inverseMap[example[3]])
  + ',' +  torsion + ',' + angle + ',' + hoseFrom + ',' + hoseTo);
...
function distance1(molecule, atom1, atom2) {
  let dx = molecule.getAtomX(atom1) - molecule.getAtomX(atom2);
  let dy = molecule.getAtomY(atom1) - molecule.getAtomY(atom2);
  let dz = molecule.getAtomZ(atom1) - molecule.getAtomZ(atom2);
