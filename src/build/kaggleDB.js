...
// distance,torsion,angle,csA,csB,mullikenA,mullikenB,
// path0,path1,path2,
// hoseA1,hoseA2,hoseA3,hoseA4,hoseA5,hoseB1,hoseB2,hoseB3,hoseB4,hoseB5
...
      let start = 18;
      let nHoses = 2;
      for (let k = start + nHoses; k >= start; k--) {
